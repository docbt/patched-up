...
val enableCustomTabsPatch = bytecodePatch(
    ...
    execute {
        with(InstructionExtensions) {
            // Step 1: Bypass experiment allowlist in Ladvi.a() (default-browser picker).
            ...
            // Step 2: Bypass allowlist-only filtering in Ladvf.a() (restrictive picker).
            ...
            // Step 3: In every method that reads Ladut.i, replace iget-boolean Ladut;->i:Z
            ...
            // Step 4: CustomTabsTrampolineActivity.onCreate() reads Ladut.c (Ladvd), calls
            ...
            val offset = (trampolineMethod.getInstruction<OffsetInstruction>(ifNezIndex)).codeOffset
            trampolineMethod.replaceInstruction(ifNezIndex, BuilderInstruction10t(Opcode.GOTO, offset))
        }
    }
}
